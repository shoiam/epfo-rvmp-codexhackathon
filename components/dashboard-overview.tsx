...
export function DashboardOverview({
  ...
  const actions: ActionCard[] = [
    { href: "/claims", title: "Claims", description: "Track your advance and settlement requests.", badge: claimsInProgress ? `${claimsInProgress} in progress` : "No claims in progress", badgeClass: claimsInProgress ? "status-pending" : "status-active", icon: FileText },
